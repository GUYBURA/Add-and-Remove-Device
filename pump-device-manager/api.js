...
app.get('/api/pump/device', (req, res) => {
    const sql = `
        SELECT 
            sp.device_id AS id,
...
app.get('/api/pump/device/:id', (req, res) => {
    const { id } = req.params;
    const sql = `
...
app.delete('/api/pump/delete/device/:id', (req, res) => {
    const { id } = req.params;
...
// ดึง station ทั้งหมด
app.get('/api/pump/housefarm', (req, res) => {
...
app.post('/api/pump/add/device', (req, res) => {
